  ...
  return (
    <footer id="contact" className="max-w-7xl mx-auto w-full px-6 py-16 border-t border-black/5 dark:border-white/5 mt-20">
      <div className="flex flex-col items-center justify-center text-center py-12 md:py-20">
        ...
        <h2 className="font-header font-extrabold text-4xl sm:text-5xl md:text-7xl lg:text-9xl tracking-tighter mb-16 md:mb-24 leading-none text-black dark:text-white">
          {"LET'S TALK"}
        </h2>
      ...
      {/* Copyright banner */}
      <div className="flex flex-col sm:flex-row items-center justify-between pt-12 border-t mt-12 text-xs sm:text-xs font-semibold border-black/5 text-gray-750 dark:border-white/5 dark:text-gray-500">
